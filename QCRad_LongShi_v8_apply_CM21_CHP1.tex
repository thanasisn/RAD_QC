...
\NormalTok{    QS}\SpecialCharTok{$}\NormalTok{Tracking\_min\_elev }\OtherTok{\textless{}{-}}   \DecValTok{10}
...
\NormalTok{    DATA[, ClrSW\_ref2 }\SpecialCharTok{:}\ErrorTok{=}\NormalTok{ ( QS}\SpecialCharTok{$}\NormalTok{ClrSW\_a }\SpecialCharTok{/}\NormalTok{ sun\_dist }\SpecialCharTok{\^{}} \DecValTok{2}\NormalTok{ ) }\SpecialCharTok{*} \FunctionTok{cosde}\NormalTok{(SZA) }\SpecialCharTok{\^{}}\NormalTok{ QS}\SpecialCharTok{$}\NormalTok{ClrSW\_b ]}
    ...
    \DocumentationTok{\#\# . . Direct {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{    DATA[wattGLB }\SpecialCharTok{/}\NormalTok{ ClrSW\_ref2 }\SpecialCharTok{\textgreater{}}\NormalTok{ QS}\SpecialCharTok{$}\NormalTok{ClrSW\_lim }\SpecialCharTok{\&}
\NormalTok{         wattDIF }\SpecialCharTok{/}\NormalTok{ wattGLB    }\SpecialCharTok{\textgreater{}}\NormalTok{ QS}\SpecialCharTok{$}\NormalTok{ClrSW\_lim }\SpecialCharTok{\&}
\NormalTok{         wattGLB              }\SpecialCharTok{\textgreater{}}\NormalTok{ QS}\SpecialCharTok{$}\NormalTok{glo\_min   }\SpecialCharTok{\&}
\NormalTok{         Elevat               }\SpecialCharTok{\textgreater{}}\NormalTok{ QS}\SpecialCharTok{$}\NormalTok{Tracking\_min\_elev,}
...
\NormalTok{    QS}\SpecialCharTok{$}\NormalTok{CL\_idx\_ele }\OtherTok{\textless{}{-}}  \DecValTok{8}     \CommentTok{\# Apply for elevations above this angle}
